...
export const widgetStyles = css`
  ...
  * { box-sizing: border-box; } button, textarea { font: inherit; } button { color: inherit; } svg { display: block; pointer-events: none; }
  ...
  .intro { padding: 5px 2px 0; } .intro-kicker, .preview-kicker, .field > span, .prompt-picker legend { color: var(--sw-color-text-muted); font-size: 10px; font-weight: 760; letter-spacing: .08em; text-transform: uppercase; } .intro-kicker { display: block; margin-bottom: 7px; } .intro h3 { font-size: 23px; letter-spacing: -.035em; line-height: 1.08; margin: 0 0 8px; } .intro p { color: var(--sw-color-text-secondary); font-size: 14px; line-height: 1.45; margin: 0; }
  .intake { display: grid; gap: 14px; } .field-group--route { align-items: end; display: grid; gap: 7px; grid-template-columns: minmax(0,1fr) auto minmax(0,1fr); } .field { display: grid; gap: 6px; min-width: 0; } .field input { background: #fff; border: 1px solid var(--sw-color-border-soft); border-radius: 12px; color: var(--sw-color-text-primary); min-height: 42px; min-width: 0; outline: none; padding: 0 11px; width: 100%; } .field input:focus-visible { border-color: var(--sw-color-accent); box-shadow: 0 0 0 3px rgba(255,118,95,.16); } .field--date { max-width: 190px; } .route-arrow { color: var(--sw-color-text-muted); font-size: 18px; padding-bottom: 10px; }
  .prompt-picker { border: 0; margin: 0; padding: 0; } .prompt-picker legend { margin-bottom: 8px; padding: 0; } .prompt-options { display: flex; flex-wrap: wrap; gap: 7px; } .prompt { background: #fff; border: 1px solid var(--sw-color-border-soft); border-radius: 999px; cursor: pointer; font-size: 12px; line-height: 1.2; padding: 9px 11px; transition: background 140ms ease, border-color 140ms ease, color 140ms ease; } .prompt:hover { border-color: #efad9f; } .prompt[aria-pressed="true"] { background: #ffe3da; border-color: #ffb09e; color: #9a3f30; font-weight: 680; }
  .intake-preview { background: #fff; border: 1px solid var(--sw-color-border-soft); border-radius: 18px; padding: 13px 14px; } .preview-heading { align-items: flex-start; display: flex; gap: 10px; justify-content: space-between; } .preview-kicker { display: block; margin-bottom: 4px; } .intake-preview h4 { font-size: 16px; letter-spacing: -.02em; margin: 0; overflow-wrap: anywhere; } .preview-edit { background: transparent; border: 0; color: var(--sw-color-accent); cursor: pointer; font-size: 12px; font-weight: 700; padding: 2px 0; } .intake-preview .request-items { margin-top: 10px; } .request-item--empty { background: #f8f3f0; color: var(--sw-color-text-muted); }
  .intake-error { background: #fff0ed; border-radius: 12px; color: #9a3f30; font-size: 13px; margin: -4px 0 0; padding: 10px 12px; } .primary-action--search { align-items: center; display: flex; gap: 8px; justify-content: center; } .primary-action--search span:last-child { font-size: 18px; line-height: 1; } .intake-note { color: var(--sw-color-text-muted); font-size: 12px; line-height: 1.4; margin: -4px 2px 0; }
  ...
  .request-item { background: #f5eeea; border-radius: 999px; color: var(--sw-color-text-secondary); display: inline-flex; font-size: 12px; padding: 6px 9px; } button.request-item { border: 1px solid transparent; cursor: pointer; text-align: left; } button.request-item:hover { border-color: #efad9f; }
  ...
  .scenario-context > span { color: var(--sw-color-text-secondary); font-size: 13px; }
  .scenario-context .request-items { margin-top: 8px; }
  .estimate-note { color: var(--sw-color-text-muted); font-size: 11px; line-height: 1.4; margin: -4px 3px 0; }
  .scenario-actions { align-items: center; display: flex; gap: 12px; justify-content: space-between; }
  .scenario-actions .primary-action { min-height: 42px; width: auto; }
  .body--presentation-live { min-height: 0; }
  .body--presentation-live .message-viewport { padding: 18px 16px 16px; }
  .body--presentation-live .content { margin: 0; max-width: none; }
  @keyframes progress-pulse { to { transform: rotate(360deg); } }
  @media (prefers-reduced-motion: reduce) { .progress-dot { animation: none; } }
  @media (max-width: 640px) { :host { bottom: 0; left: 0; right: 0; } .panel { border: 0; border-radius: 0; height: 100dvh; max-height: none; width: 100vw; } :host([layout="presentation"]) .panel { height: 100dvh; } .launcher { bottom: max(16px, env(safe-area-inset-bottom)); position: fixed; right: max(16px, env(safe-area-inset-right)); } .presentation-shell { padding: 12px 14px 14px; } }
`;
